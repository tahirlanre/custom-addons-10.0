...
class AssetReportXlsx(ReportXlsx):
    ...
    def _get_report_columns(self):
        return {
                0: {'header': 'Asset Description',
                    'field': 'description',
                    'width': 30},
                1: {'header': 'Purchase Date',
                    'field': 'purchase_date',
                    'width': 15},
                2: {'header': 'Purchase Price',
    ...
    def _get_report_name(self):
        return _("Asset Register Report")
...
AssetReportXlsx('report.account_asset_report.asset_report_xlsx','report_asset_register_qweb',parser=report_sxw.rml_parse)
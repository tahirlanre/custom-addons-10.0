...
class inventory_sales_analysis(models.TransientModel):
    
    _name = 'report_inventory_sales_analysis_qweb'
    ...
    product_ids = fields.One2many(comodel_name='report_inventory_sales_analysis_product', inverse_name='report_id')
    line_ids = fields.One2many(comodel_name='report_inventory_sales_analysis_line', inverse_name='report_id')
    partner_ids = fields.One2many(comodel_name='report_inventory_sales_analysis_partner', inverse_name='report_id')
    sales_rep_ids = fields.One2many(comodel_name='report_inventory_sales_analysis_sales_rep', inverse_name='report_id')
    ...
    def print_report(self, xlsx_report):
        ...
        if xlsx_report:
            report_name='inventory_sales_analysis.inventory_sales_analysis_xlsx'
        else:
            report_name='inventory_sales_analysis.report_inventory_sales_analysis_qweb'
    ...
    def inject_product_values(self):
        query_inject_product = """
            INSERT INTO
                report_inventory_sales_analysis_product
                (
                    report_id,
                    create_uid,
                    create_date,
    ...
    def inject_partner_values(self):
        query_inject_partner = """
            INSERT INTO
                report_inventory_sales_analysis_partner
                (
                    report_id,
                    create_uid,
                    create_date,
    ...
    def inject_sales_rep_values(self):
        query_inject_sales_rep = """
            INSERT INTO
                report_inventory_sales_analysis_sales_rep
                (
                    report_id,
                    create_uid,
                    create_date,
...
class InventorySalesAnalysisProduct(models.TransientModel):
    _name = 'report_inventory_sales_analysis_product'
    ...
    report_id = fields.Many2one(comodel_name='report_inventory_sales_analysis_qweb', ondelete='cascade', index=True)

class InventorySalesAnalysisPartner(models.TransientModel):
    _name = 'report_inventory_sales_analysis_partner'
...
class InventorySalesAnalysisSalesRep(models.TransientModel):
    _name = 'report_inventory_sales_analysis_sales_rep'
...
class InventorySalesAnalysisLine(models.TransientModel):
    _name = 'report_inventory_sales_analysis_line'
